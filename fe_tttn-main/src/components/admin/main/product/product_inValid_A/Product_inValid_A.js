...
import { PutProduct, ShowProductInValid } from '../../../../../Services/ProductService';
import starImage from '../../../../../assets/images/star.png';
import ModalView from './ModalView';
import { toast } from 'react-toastify';
import IntroP_C_A from '../../../secondary/introP_C_A/ItroP_C_A';
import { Badge } from 'react-bootstrap';
function Product_inValid_A() {
    ...
    const handleEditValid = async (item, getIsValidValue) => {
        try {
            ...
            if (res && res.data) {
                ...
                const updatedListProduct = listproduct.filter((product) => product.id !== item.id);
    ...
    const getProducts = async () => {
        try {
            let res = await ShowProductInValid();
            if (res && res.data) {
...
export default Product_inValid_A;
